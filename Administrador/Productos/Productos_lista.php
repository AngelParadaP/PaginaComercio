...
<body>
    ...
    <div class="container">
        ...
        <a href="ProductosAlta.php" class="button-create"></a>
...
echo "
    <div class='card' data-id='$id'>
        <a href='./verdetalles_producto.php?id=$id' style='text-decoration: none; color: inherit;'> <!-- Envolver toda la tarjeta en un enlace -->
        ...
        <div class='card-buttons'>
            <a href='./verdetalles_producto.php?id=$id' class='button-details'>Ver detalles</a>
            <a href='./editar_productos.php?id=$id' class='button-edit'>Editar</a>
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.success) {
                        ...
                        Toastify({
                            text: "Error al eliminar el producto: " + response.error,
                            duration: 3000,
                            backgroundColor: "red"
                        }).showToast();
                    }
